(mozilla-projects-nss-ssl-functions-sslkey)=
...
[Chapter 6](#chapter_6_key_functions) Key Functions
...
copy. When you call `` `CERT_DestroyCertificate `` \<sslcrt.html#1050532>\`\_\_ or
`` `SECKEY_DestroyPrivateKey `` \<#1051017>\`\_\_, the function decrements the reference count and, if
