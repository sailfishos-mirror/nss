(mozilla-projects-nss-s-mime-functions)=

# S/MIME functions

:::{container}
The public functions listed here perform S/MIME operations using the [S/MIME
Toolkit](http://www-archive.mozilla.org/projects/security/pki/nss/smime/).

The [Mozilla Cross Reference](http://mxr.mozilla.org/) (MXR) link for each function provides
