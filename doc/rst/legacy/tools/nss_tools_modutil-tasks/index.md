(mozilla-projects-nss-tools-nss-tools-modutil-tasks)=

# NSS Tools modutil-tasks

## [NSS Security Tools: modutil Tasks](#nss_security_tools_modutil_tasks)
...
:::{container}
1. The jar installation script is very fragile with respect to platform definitions (especially
