(mozilla-projects-nss-tools-nss-tools-cmsutil)=
...
The cmsutil command-line utility uses the [S/MIME Toolkit](../smime/) to perform basic
operations, such as encryption and decryption, on [Cryptographic Message
Syntax (CMS)](http://www.ietf.org/rfc/rfc2630.txt) messages.
:::
