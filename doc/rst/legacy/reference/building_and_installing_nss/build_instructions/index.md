(mozilla-projects-nss-reference-building-and-installing-nss-build-instructions)=
...
For Windows, install
the [MozillaBuild](https://firefox-source-docs.mozilla.org/setup/windows_build.html#install-mozillabuild) environment
...
2. If you want to build a releases other than the tips of these repositories, then switch to the
   release tags:
...
3. Set environment variables:
   ...
   1. If you want a non-debug optimized build, set `BUILD_OPT=1` in your environment.
   ...
   2. On Unix platforms, except Alpha/OSF1, if you want a build for the system's 64-bit ABI, set
      `USE_64=1` in your environment. By default, NSS builds for the 32-bit environment on all
      platforms except Alpha/OSF1.

   3. To build with `gcc` on platforms other than Linux and Windows, you need to set two more
