...
## [New in NSS 3.41](#new_in_nss_3.41)
...
- [Bug 1423043](https://bugzilla.mozilla.org/show_bug.cgi?id=1423043) - Enable half-closed
  states for TLS.

- [Bug 1493215](https://bugzilla.mozilla.org/show_bug.cgi?id=1493215) - Enabled the following
...
- [Bug 1481271](https://bugzilla.mozilla.org/show_bug.cgi?id=1481271) - Resend the same
  ticket in ClientHello after HelloRetryRequest
- [Bug 1493769](https://bugzilla.mozilla.org/show_bug.cgi?id=1493769) - Set session_id for
  external resumption tokens
- [Bug 1507179](https://bugzilla.mozilla.org/show_bug.cgi?id=1507179) - Reject CCS after
