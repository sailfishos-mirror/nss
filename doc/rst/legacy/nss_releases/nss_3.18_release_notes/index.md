...
## [New in NSS 3.18](#new_in_nss_3.18)
...
- *in pk11pub.h*
  ...
  - **\_\_PK11_SetCertificateNickname** - this is an internal symbol for NSS use only, as with
...
## [Bugs fixed in NSS 3.18](#bugs_fixed_in_nss_3.18)
