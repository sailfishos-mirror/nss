...
## [New in NSS 3.20](#new_in_nss_3.20)
...
- The server side implementation of the TLS does not support session tickets while using a DHE
  ciphersuite (see [bug 1174677](https://bugzilla.mozilla.org/show_bug.cgi?id=1174677)).
...
- NSS embeds fixed DHE parameters sized 2048, 3072, 4096, 6144 and 8192 bits, which were copied
  ...
  Parameters for
  TLS"](https://datatracker.ietf.org/doc/html/draft-ietf-tls-negotiated-ff-dhe-08), Appendix
  A.
...
## [Bugs fixed in NSS 3.20](#bugs_fixed_in_nss_3.20)
...
at \` bugzilla.mozilla.org \<<https://bugzilla.mozilla.org/enter_bug.cgi?product=NSS>>\`\_\_ (product
NSS).
:::
