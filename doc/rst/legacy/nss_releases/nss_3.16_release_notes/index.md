...
- [Bug 903885](https://bugzilla.mozilla.org/show_bug.cgi?id=903885): (CVE-2014-1492) In a
  ...
  7.2](https://datatracker.ietf.org/doc/html/rfc6125#section-7.2).
- [Bug 962760](https://bugzilla.mozilla.org/show_bug.cgi?id=962760): libpkix should not
  include the common name of CA as DNS names when evaluating name constraints.
- [Bug 981170](https://bugzilla.mozilla.org/show_bug.cgi?id=981170): AESKeyWrap_Decrypt
  should not return SECSuccess for invalid keys.
- [Bug 974693](https://bugzilla.mozilla.org/show_bug.cgi?id=974693): Fix a memory corruption
  in sec_pkcs12_new_asafe.
- [Bug 956082](https://bugzilla.mozilla.org/show_bug.cgi?id=956082): If the NSS_SDB_USE_CACHE
