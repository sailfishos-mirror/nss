...
- [Bug 1112461](https://bugzilla.mozilla.org/show_bug.cgi?id=1112461): libpkix was fixed to
  prefer the newest certificate, if multiple certificates match.
- [Bug 1094492](https://bugzilla.mozilla.org/show_bug.cgi?id=1094492): fixed a memory
  corruption issue during failure of keypair generation.
- [Bug 1113632](https://bugzilla.mozilla.org/show_bug.cgi?id=1113632): fixed a failure to
  reload a PKCS#11 module in FIPS mode.
- [Bug 1119983](https://bugzilla.mozilla.org/show_bug.cgi?id=1119983): fixed interoperability
