...
- TLS extended master secret extension ([RFC
  7627](https://datatracker.ietf.org/doc/html/rfc7627)) is supported ([bug
  1117022](https://bugzilla.mozilla.org/show_bug.cgi?id=1117022))
- New info functions added for use during mid-handshake callbacks ([bug
  1084669](https://bugzilla.mozilla.org/show_bug.cgi?id=1084669))
...
- *in sslt.h*
  ...
  - **SSL_ENABLE_EXTENDED_MASTER_SECRET** - configuration to enable the TLS extended master
    secret extension ([RFC 7627](https://datatracker.ietf.org/doc/html/rfc7627))
...
- NSS now builds with warnings as errors ([bug
  1182667](https://bugzilla.mozilla.org/show_bug.cgi?id=1182667))
