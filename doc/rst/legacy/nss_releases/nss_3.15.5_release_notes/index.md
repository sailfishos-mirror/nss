...
## [New in NSS 3.15.5](#new_in_nss_3.15.5)
...
- Added the TLS [padding
  extension](https://datatracker.ietf.org/doc/html/draft-agl-tls-padding). The extension type
...
### [Bugs fixed in NSS 3.15.5](#bugs_fixed_in_nss_3.15.5)
