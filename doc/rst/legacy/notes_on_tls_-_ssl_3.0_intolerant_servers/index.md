(mozilla-projects-nss-notes-on-tls-ssl-3-0-intolerant-servers)=
...
[bug 59321](https://bugzilla.mozilla.org/show_bug.cgi?id=59321).
:::
...
- IBM_HTTP_Server/1.3.12.1 or earlier (\* [Update to
  1.3.12.2](http://www6.software.ibm.com/dl/websphere/http-p))
- Java Web Server 2
...
[bug 59321](https://bugzilla.mozilla.org/show_bug.cgi?id=59321) which keeps a list of TLS/SSL
...
2](https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Releases/2/Security_changes) for
details.
:::
...
- *Optional:*Get the name of the SSL server software used by the website. To do so, add
  ...
  [http://toolbar.netcraft.com/site_rep...a.mozilla.org/](http://toolbar.netcraft.com/site_report?url=https://bugzilla.mozilla.org/).
- Add the information on such a server (software, URL) to
  [bug 59321](https://bugzilla.mozilla.org/show_bug.cgi?id=59321) at Bugzilla. (Note: You
