...
################## main #################################################
GTESTS="${GTESTS:-base_gtest certhigh_gtest certdb_gtest der_gtest pk11_gtest util_gtest freebl_gtest softoken_gtest softoken_static_gtest sysinit_gtest smime_gtest mozpkix_gtest cryptohi_gtest}"
gtest_init "$0"
gtest_start
gtest_cleanup
